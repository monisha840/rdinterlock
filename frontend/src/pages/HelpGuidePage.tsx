...
const sections: Section[] = [
  ...
  },
  {
    ...
    features: [
      ...
      {
        title: "Fleets, EMI & Vehicle Expenses",
        whatItDoes: [
          ...
          "Track overdue EMIs",
          "Record vehicle expenses — Diesel, Maintenance, Tyre, Servicing, Insurance, Repair, Spare Parts",
        ],
        howToUse: [
          ...
          "Add Vehicle Expense: go to Expenses tab → 'Add Expense' → select vehicle, type, amount → Save",
        ],
        outputSeenAt: [
          "Fleet tab — all vehicles",
          "EMI tab — pending, paid, overdue EMIs",
          "Expenses tab — all vehicle expenses with total",
          "Cash Book — all expenses and EMI payments appear there too",
          "Dashboard — reminders for upcoming EMIs",
        ],
        recordStoredIn: "Vehicle database + EMI database + Cash Book.",
...
const quickRefData = [
  ...
  { action: "Vehicle expense", enterAt: "Fleets → Expenses tab", seenAt: "Expenses tab, Cash Book, Dashboard" },
